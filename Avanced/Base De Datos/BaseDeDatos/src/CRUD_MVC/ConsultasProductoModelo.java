...
public class ConsultasProductoModelo extends ConexionModelo{
	
	
	public boolean Registrar(ProductoModelo pro) {
	...
	public boolean Modificar(ProductoModelo pro) {
	...
	public boolean Eliminar(ProductoModelo pro) {
		PreparedStatement ps = null;
		Connection con = getConexion();
	...
	public boolean Buscar(ProductoModelo pro) {
		PreparedStatement ps = null;
		ResultSet rs = null;
		Connection con = getConexion();
